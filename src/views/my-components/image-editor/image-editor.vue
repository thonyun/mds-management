                    ...
                    <Row :gutter="10">
                        ...
                        <Col span="10" class="image-editor-con1">
                            ...
                            <div class="image-editor-con1-btn-con margin-top-10">
                                ...
                                <label class="filelabel" for="fileinput1"><Icon type="md-image" />&nbsp;选择图片</label>
                                <span><Button @click="handlecrop1" type="primary" icon="md-crop">裁剪</Button></span>
                            </div>
                    ...
                    <Col span="6" class="image-editor-con3">
                        <Row>
                            <Col span="24" class="image-editor-con3-btn-box">
                                ...
                                <label class="filelabel filelabel3" for="fileinput3"><Icon type="md-image" />&nbsp;选择图片</label>
                            </Col>
                        </Row>
                        <Row class="margin-top-10">
                        ...
                        <Row class="margin-top-10">
                            <Col span="24" class="crop3-btn-box">
                                <Button @click="handlecrop3" style="width: 190px;" icon="md-crop" type="primary">裁剪</Button>
                            </Col>
