<template>
  <Card dis-hover>
    <p slot="title">手机号为{{filters.mobile}}的用户妈星币流水记录</p>
		...
		data() {
			return {
				...
				columns: [
					...
					{title: '行为活动/规则名称', align: 'center', key: 'ruleName'},
					{
						title: '妈星币个数', align: 'center', key: 'score', render: (h, params) => {
